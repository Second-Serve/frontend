...
- **Owen**: Created the app's old Python backend, then subsequently ported it to Firebase cloud functions with TypeScript, including the account system, order system, and geolocation.
